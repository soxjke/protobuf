...
system("find . -iname '*.h' -print0 | while read -d $'\\0' -r file ; do sed '/.pb.h\"/.h\"/' \"$file\" > ./tmp\ & mv ./tmp \"$file\"\; done")
system("find . -iname '*.m' -print0 | while read -d $'\\0' -r file ; do sed '/.pb.h\"/.h\"/' \"$file\" > ./tmp\ & mv ./tmp \"$file\"\; done")
